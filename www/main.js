...
var map = {
	"./add-sport-center/add-sport-center.module": [
	...
	"./view-sport-center/view-sport-center.module": [
...
var PostProvider = /** @class */ (function () {
    ...
    function PostProvider(http) {
        this.http = http;
        this.server = "http://192.168.43.107/sportapp/server_api/"; // default
    }
...
module.exports = __webpack_require__(/*! D:\Xampp\htdocs\sportapp\firstProject\src\main.ts */"./src/main.ts");
